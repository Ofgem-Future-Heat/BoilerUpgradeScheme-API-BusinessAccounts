...
namespace Ofgem.API.BUS.BusinessAccounts.Providers.DataAccess.Migrations
{
    ...
    [Migration("20220428123654_bank-account-changes-and-added-bank-account-status")]
    partial class bankaccountchangesandaddedbankaccountstatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<Guid?>("BankAccountStatusID")
                        .IsRequired()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BankAccountStatusID");
            ...
            modelBuilder.Entity("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.BankAccountStatus", b =>
                {
                    ...
                    b.ToTable("BankAccountsStatuses");
                });
            ...
            modelBuilder.Entity("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.BankAccount", b =>
                {
                    b.HasOne("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.BankAccountStatus", "BankAccountStatus")
                        .WithMany()
                        .HasForeignKey("BankAccountStatusID")
                    ...
                    b.Navigation("BankAccountStatus");
                });
