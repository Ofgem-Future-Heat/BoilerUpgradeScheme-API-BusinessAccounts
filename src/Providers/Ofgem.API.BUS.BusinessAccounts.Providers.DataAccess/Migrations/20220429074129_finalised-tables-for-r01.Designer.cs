...
namespace Ofgem.API.BUS.BusinessAccounts.Providers.DataAccess.Migrations
{
    ...
    [Migration("20220429074129_finalised-tables-for-r01")]
    partial class finalisedtablesforr01
    {
            ...
            modelBuilder.Entity("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.BusinessAccount", b =>
                {
                    ...
                    b.Property<string>("DARecommendation")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("QCRecommendation")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.CompaniesHouseDetails", b =>
                {
                    b.HasOne("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.BusinessAccount", "BusinessAccount")
                        ...
                        .HasForeignKey("Ofgem.API.BUS.BusinessAccounts.Domain.Entities.CompaniesHouseDetails", "BusinessAccountID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
